...
export default function CategoriesPage() {
  ...
  const getCategoryColor = (index: number) =>
    colors.length
      ...
      : { button_hex: '#4f46e5', text_color: '#fff', button_hover_color: '#4338ca' };
    ...
    <div className="max-w-5xl mx-auto p-4 sm:p-6">
      ...
      <div className="flex justify-end mb-4">
        <Link
          ...
          className="px-5 py-2 rounded-2xl font-semibold shadow hover:opacity-80 transition"
        >
          + Add Category
        </Link>
      </div>
            ...
            {categories.map((cat, index) => {
              ...
              return (
                <tr key={cat.id} className="hover:bg-gray-50 transition">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-800 font-medium">{cat.name}</td>
